...
//! Visual testing infrastructure for Gearbox.
//!
//! This module provides utilities for visual regression testing of Gearbox's UI.
//! It allows capturing screenshots of the real Gearbox application window and comparing
...
/// Initialize a visual test context with all necessary Gearbox subsystems.
...
mod tests {
    ...
    /// This test captures a screenshot of an empty Gearbox workspace.
    ///
