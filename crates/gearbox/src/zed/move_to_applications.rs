...
impl MoveToApplicationsRequest {
    ...
    async fn prompt(
        ...
        let response = cx
            .prompt(
                PromptLevel::Info,
                "Move Gearbox to Applications?",
                Some(
                    "Gearbox is running from a temporary location. Move it to Applications to finish installing it.",
                ),
                &[
                    PromptButton::ok("Yes"),
            ...
            0 => {
                ...
                if let Err(error) = move_to_applications(&self.app_path, cx).await {
                    ...
                    cx.prompt(
                        ...
                        "Failed to move Gearbox to Applications",
        ...
        v_flex()
            ...
            .child(
                div()
                    ...
                    .child(Label::new("Installing Gearbox...")),
            )
            .child(
                h_flex()
                    .w_full()
                    ...
                    .child(
                        v_flex()
                            .gap_1()
                            .child(Label::new("Moving Gearbox to Applications"))
                            .child(
                                Label::new("Gearbox will reopen when installation is complete.")
