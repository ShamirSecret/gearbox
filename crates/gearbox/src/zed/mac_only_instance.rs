...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Gearbox Editor Dev Instance Running",
        ReleaseChannel::Nightly => "Gearbox Editor Nightly Instance Running",
        ReleaseChannel::Preview => "Gearbox Editor Preview Instance Running",
        ReleaseChannel::Stable => "Gearbox Editor Stable Instance Running",
    }
}
