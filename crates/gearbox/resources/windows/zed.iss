...
[Files]
Source: "{#ResourcesDir}\Gearbox.exe"; DestDir: "{code:GetInstallDir}"; Flags: ignoreversion
...
; URI Scheme
Root: HKCU; Subkey: "Software\Classes\gearbox"; ValueType: "string"; ValueData: "URL:zed Protocol"; Flags: uninsdeletekey
Root: HKCU; Subkey: "Software\Classes\gearbox"; ValueType: "string"; ValueName: "URL Protocol"; ValueData: ""
Root: HKCU; Subkey: "Software\Classes\gearbox\DefaultIcon"; ValueType: "string"; ValueData: "{app}\Gearbox.exe,1"
Root: HKCU; Subkey: "Software\Classes\gearbox\shell\open\command"; ValueType: "string"; ValueData: """{app}\Gearbox.exe"" ""%1"""
